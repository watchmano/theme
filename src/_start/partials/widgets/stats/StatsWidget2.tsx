    ...
    <div className={`card ${className}`}>
      ...
      <div className="card-header align-items-center border-0 mt-5">
        <h3 className="card-title align-items-start flex-column">
          <span className="fw-bolder text-dark fs-3">Exhibitions</span>
          <span className="text-muted mt-2 fw-bold fs-6">890,344 총 조회수</span>
        </h3>
          ...
          >
            ...
            >
              ...
              <div className="d-flex justify-content-center mb-10">
                {/* begin::Item */}
                <div className="px-10">
                  <span className="text-muted fw-bold fs-7">페이지 로드</span>
                ...
                {/* begin::Item */}
                <div className="px-10">
                  <span className="text-muted fw-bold fs-7">클릭수</span>
                  <span className="text-gray-800 fw-bolder fs-3 d-block">
                    $2,040
                  </span>
                </div>
