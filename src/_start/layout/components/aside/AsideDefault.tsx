...
export function AsideDefault() {
  ...
  const {sideMenu, switchSideMenu} = sideMenuContext
                  ...
                  <ul className="nav flex-column">
                    ...
                    <li className="nav-item mb-1" title="Project Management">
                      <a
                        ...
                        onClick={()=> {
                          history.push({
                            pathname:  "/shop/shop-2"
                         });
                        //  switchSideMenu('exhibitions')
                        }}
              ...
              >
                {!config.aside.primaryDisplay ? (
                  ...
                  <div className="tab-content">
                    ...
                    {/* begin::Demo menu */}
                    <div className="tab-pane fade show active" id="kt_aside_tab_2">
                    {/* <div>person tab</div> */}
                      <AsideMenu
                        // menuType="person"
                        menuType={sideMenu}
                    ...
                    {/* <div>exhibition tab</div> */}
                      <AsideMenu
                        menuType="exhibitions"
                        // menuType={sideMenu}
                        asidePrimaryDisplay={config.aside.primaryDisplay}
